      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="h-12 flex justify-end items-center px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 gap-2 sm:gap-4">
          ...
          >
            ...
            <span className="text-gray-900 font-telegraf text-sm font-medium group-hover:text-blue-600 transition-colors duration-200">
              Login
            </span>
          </a>

          {/* Fale com um especialista button */}
          <button className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 rounded-lg bg-homeflip-purple text-white hover:bg-[#4A0D5F] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-homeflip-purple/50 font-telegraf text-xs sm:text-sm font-medium whitespace-nowrap shadow-lg hover:shadow-xl">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
        ...
        <div className="h-16 sm:h-18 md:h-20 lg:h-24 xl:h-[107px] flex items-center px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          ...
          {/* Favoritos e campo de busca - justificados à direita */}
          <div className="hidden lg:flex items-center gap-4">
            ...
            <div className="flex items-center bg-gray-50 rounded-lg px-4 py-2 min-w-[200px] hover:bg-gray-100 transition-colors duration-200">
              ...
              <input
                ...
                className="bg-transparent outline-none text-sm font-montserrat placeholder-gray-400 flex-1"
              />
            </div>
          </div>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 py-6 border-t border-gray-200 space-y-3">
            ...
            >
              ...
              <span className="text-gray-900 font-telegraf text-base font-medium">
                Fazer Login
              </span>
            </a>
