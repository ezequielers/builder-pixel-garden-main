    ...
    <section className="w-full bg-white shadow-[0px_4px_200px_0px_rgba(232,249,247,0.20)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 font-inter mb-3">
            Com base na sua localização
          </h2>
          <p className="text-gray-600 font-inter text-sm md:text-base max-w-2xl mx-auto">
