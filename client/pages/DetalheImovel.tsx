          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2 space-y-4 md:space-y-6">
              ...
              <div className="relative">
                ...
                {/* Thumbnail Gallery */}
                {property.images.length > 1 && (
                  <div className="flex gap-2 mt-2 md:mt-4 overflow-x-auto scrollbar-hide">
              ...
              <Card>
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="text-2xl md:text-3xl font-bold text-homeflip-purple mb-4 md:mb-6">
                    {property.price}
                  </div>
              ...
              <Card className="lg:sticky lg:top-8">
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="space-y-2 md:space-y-3">
                    <Link to={`/proposta-expressa?imovel=${property.id}`}>
                      <Button
                    ...
                    {[1, 2, 3].map((item) => (
                      <div key={item} className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs md:text-sm font-semibold text-homeflip-purple">
                            R$ {2000 + item * 300}/mês
                          </div>
                        </div>
                      </div>
